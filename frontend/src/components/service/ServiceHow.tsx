...
export type StepItem = { icon?: string; t: string; d: string };
...
export default function ServiceHow({
  eyebrow,
  title,
  steps,
}: {
  ...
  const lineScale = reduce ? 1 : smooth;
        ...
        >
          ...
          <Typography
            ...
            sx={{
              ...
              animation: "swHowShimmer 6s linear infinite",
              "@keyframes swHowShimmer": {
